...
EXPECTED_FRAGMENTS = (
    ...
    "scripts/15-board.js.part",
    "scripts/20-quota.js.part",
    "scripts/21-quotafill.js.part",
    "scripts/22-quotatable.js.part",
    "scripts/30-sessions.js.part",
    "scripts/40-configs.js.part",
    "scripts/50-work.js.part",
    "scripts/55-injectpack.js.part",
