...
THE CONTROL LAW (docs/PLAN-CLARITY.md, from the day three helm guards proved
...
class OwnerBoundCallSitesTest(unittest.TestCase):
    ...
    def test_the_chat_gate_does_not_PREFIX_match_the_owner_name(self):
        """codex-3's finding: a raw `"@" + name in text` substring test fires
        on @ownerson and @owner-extra. The gate uses the boundary-aware
