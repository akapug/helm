...
class WebNotesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # NEXT test. codex-2's contract requires each site to redden ONLY its
    ...
    def test_poll_stamp_is_bracketed(self):
        ...
        # stamp: a poll writing now-15s would still have passed (codex-2, on
        ...
        # starved box, so age crossed again after the injection (codex-2
    ...
    def test_fresh_quiet_boundary(self):
        """codex-2's other route: test the owner row DIRECTLY rather than
        ...
        # mutation redden TWO arms — which is exactly the signal codex-2's
    ...
    def test_owner_graft_does_not_mutate_cached_roster(self):
        ...
        (codex-2, on 6024baa2f2ad). The contract calls for the graft to be the
