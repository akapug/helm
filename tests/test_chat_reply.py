...
class ReplyRowTest(ReplyBase):
    ...
    def test_post_prints_the_id_other_verbs_require(self):
        ...
        Live 2026-07-26: that scrape returned SCROLLBACK rather than the new row
...
class ReplyRenderTest(ReplyBase):
    ...
    def test_fmt_without_an_index_carries_NO_THREAD_DECORATION(self):
        ...
        This asserted a byte-identical string until 2026-07-25, when the
...
class VerdictDigestTest(unittest.TestCase):
    """chat:verdict:b2b: — the dispatch-verdict claim space (bd-173ca9).
...
class VerdictShapeAttackTest(unittest.TestCase):
    """Xrev findings 1+3: the downgrade and shape-overlap attacks."""
