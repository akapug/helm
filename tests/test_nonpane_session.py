...
"subagents". codex-3 measured from inside its own turn-loop that an Agent-tool
...
class SameSidSidechainLimitTest(Base):
    ...
    Measured by codex-3 from inside its own turn-loop (2026-07-24):
...
class NoSelfLockoutTest(Base):
    ...
    def test_the_identity_law_never_reads_the_child_marker(self):
        ...
        reads = ('environ.get("CLAUDE_CODE_CHILD_SESSION")',
                 ...
                 "child_session(")
        # THE SEATS FAMILY IS A GLOB, NOT A FILENAME. @codex-3: this scanned
        ...
        # ALL THREE FAMILIES ARE GLOBS. @codex-3: I converted only seats*
