...
4. **Chat and live state**: `helm chat read`, `helm chat pending`, `helm who`,
   `helm work list`, and the relevant room's history.
...
- chat: <room/row id or live reading / NO_CHAT_RECORD>
