...
def cmd_launch(args):
    ...
    cwd = seats.safe_cwd()
    # home.chat_name is THE validated seam: a hostile HELM_CHAT_NAME is rejected
    # (home.SeatNameError) here rather than exported to the child as its identity.
    seat = (opts["seat"] or home.chat_name()
