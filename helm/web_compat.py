...
_OWNER_NAMES = (
    ...
    ('web_core', (
        'ENTRY_KEYS', 'ENTRY_CAP', 'REVIEW_STMT_CAP', '_api_registry', '_api_store',
    ...
    ('web_configs', (
        '_api_configs', '_api_configs_cascade', '_api_configs_tree',
    ...
    ('web_quota', (
        ...
        'get_allocations', '_api_creds', '_api_history', '_api_burn',
        '_api_allocate', '_api_quota_status',
    )),
    ('web_chat_rooms', (
    ...
    ('web_land_model', (
        ...
        '_LR_CLOSED_CAP', '_LR_LANDS_CAP', '_LR_LANDS_WINDOW_S', '_LR_FOLD',
        '_lr_ledger_paths', '_lr_newest_mtime', '_lr_epoch', '_lr_window',
        '_lr_repo', '_lr_witnessed', '_lr_recent_lands', '_lr_native_chain',
    )),
    ('web_land', (
        '_lr_project', '_lr_build', '_api_lr',
    )),
    ('web_ledger', (
        'LEDGER_TURNS', 'LEDGER_STATUS_KEYS', '_TURN_HASH', '_turn_about',
