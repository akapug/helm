...
The unification of the predecessor's four near-clone resolvers (priors.py + lexicon.py +
...
from .load import (
    ...
    _attested_priors, load_all, entries, candidates, reviewable, counts, _find,
    FLEET, HOME_PROJECT, RECORDED, ROOT_PROJECT, ADOPTED_FLEET, STATEMENT,
    entry_project, entry_scope, scope_label, names_helm_artifact, injects_into,
    scope_census,
    load_certain_policy, policy_declared, gate_ids, link_gates, split_gate,
    gate_candidates, resolve_gate, gate_key, typed_id, find_typed,
)
from .resolve import (
    _probes, _own_probes, _gate_probes, _jit_candidates, _df_map, _probe_hits,
    resolve_prompt, pinned, routed, routes, ROUTE_PREFIX, NOTICE_PREFIX,
    route_cell, legacy_route_cells,
)
from .write import (
