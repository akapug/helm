...
_VERB_HELP = {
    ...
    "seat": "seat add|up|down|launch|resume|smoke|list|status — multimodel seats (codex family via local proxy); resume <seat> relaunches the pane via the detected metaharness (orca/herdr), freshest launch.sh + claude --resume/--continue",
