...
_VERB_HELP = {
    ...
    "codex": "codex [list]|pool <name>|unpool <name>|pooled — codexhome roster (ultra/team) + proxy cred pooling: translate ~/.codex-homes/<name>/auth.json into the seat proxy's hot-reloaded auth-dir (0600), so the :8317 pool falls through usage caps",
