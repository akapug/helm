...
_VERB_HELP = {
    ...
    "capabilities": "capabilities [--public] [--json] — the wired-substrate SELF-INDEX: what helm gives you (verb -> what -> wired-via -> live/absent), grouped core vs powerpack. The SAME index JIT-surfaces one line at the reasoning moment via inject (a2a/converge -> meld+chat-deliver; 'solved this before' -> recall). --public withholds private-hold powerpacks",
