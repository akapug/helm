...
Tripwires (over-engineering signals): per-file claims, approval steps, a second
registry, queues/priorities on lanes, a daemon — any of these is the
over-engineering slide; stop.
"""
...
from ._gc import (
    RETIRABLE, estate_phantom_records, format_gc_summary, gc_enact, gc_orphans,
    gc_scan, lane_overlaps, list_rows, phantom_records, phantom_scan,
