...
from . import harnesses, home, vcs
...
def _scan_roots():
    """The repo-scan roots — `home.scan_roots`, which owns the one read of
    HELM_SCAN_ROOTS so a per-tool-call hook can ask without importing this
    module."""
    return home.scan_roots()
