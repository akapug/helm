...
def pull():
    ...
    try:
        ...
        print("helm ship pull: registry authority UNKNOWN: %s" % exc, file=sys.stderr)
        return 1
...
def _pull():
    ...
    # The imported authored file is already visible. Invalid authority remains
    # recoverable in Git and reads UNKNOWN; do not scaffold or overwrite it via
    # resync, and do not pretend that the writer lock makes the import atomic.
    from . import registry
