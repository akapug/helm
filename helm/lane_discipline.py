...
its private worktree -> gate the whole suite -> a cross-family reviewer
APPROVEs carrying the gate token -> the integrator FOLDS it to main.
...
def _refusal(root, detail):
    ...
    return [
        ...
        "verdict covers it — and that is not the worst of it: every lane cut "
